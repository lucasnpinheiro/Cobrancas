...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        echo $this->Form->select2('telefone', ['multiple' => true, 'label' => 'Telefones', 'div' => ['class' => 'col-xs-12 col-md-12']], [ 'tags' => true, 'tokenSeparators' => [',']]);
        echo $this->Form->select2('email', ['multiple' => true, 'label' => 'E-mails', 'div' => ['class' => 'col-xs-12 col-md-12']], [ 'tags' => true, 'tokenSeparators' => [',', ' ']]);
        ?>
    </div>
