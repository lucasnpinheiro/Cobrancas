...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?= __('Alterar Usuários') ?></h3>
    </div>
    <div class="panel-body">
        ...
        echo $this->Form->select2('telefone', ['multiple' => true, 'type' => 'select', 'label' => 'Telefones', 'div' => ['class' => 'col-xs-12 col-md-12']], ['dados' => $usuario->telefones, 'multiple' => true, 'tags' => true, 'tokenSeparators' => [',', ' ']]);
        echo $this->Form->select2('email', ['multiple' => true, 'label' => 'E-mails', 'div' => ['class' => 'col-xs-12 col-md-12']], ['dados' => $usuario->emails, 'multiple' => true, 'tags' => true, 'tokenSeparators' => [',', ' ']]);
        ?>
    </div>
