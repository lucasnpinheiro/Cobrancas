...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?= __('Alterar Pedido') ?></h3>
    </div>
    <div class="panel-body">
        ...
        echo $this->Form->data('data_ultima_emissao', ['value'=>$pedido->data_ultima_emissao->format('Y-m-d'),'empty' => true, 'default' => '', 'div' => ['class' => 'col-xs-12 col-md-4']]);
